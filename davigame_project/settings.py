"""
Django settings for davigame_project project.
...
SECRET_KEY = 'django-insecure-(5_ked+z(n0ue=$6r58gvgr#^m@(9!1d_4twirjxe)3f8^^q$w'
...
ROOT_URLCONF = 'davigame_project.urls'
...
WSGI_APPLICATION = 'davigame_project.wsgi.application'
...
SECURE_CONNECT_BUNDLE = os.path.join(BASE_DIR, 'secure-connect-davigame.zip'),
